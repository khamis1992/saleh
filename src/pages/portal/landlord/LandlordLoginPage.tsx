        ...
        <Card className="border-2 border-emerald-100 shadow-lg">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label className="text-[12px]">{tt('properties.code', 'كود العقار')}</Label>
                <div className="relative">
                ...
                <p className="text-[12px] text-[#64748d]">كود العقار الذي تتابعه (PROP-001، PROP-002، إلخ)</p>
              </div>
            ...
            <div className="mt-5 p-3 bg-emerald-50/50 border border-emerald-100 rounded-lg">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <p className="text-[12px] font-semibold text-emerald-700">حسابات تجريبية (اضغط للتعبئة):</p>
              </div>
              <div className="space-y-1">
                <button type="button" onClick={() => fillDemo('owner@alnoor.com', 'PROP-001')} className="block w-full text-right text-[12px] text-gray-700 hover:text-emerald-600 hover:bg-white px-2 py-1 rounded">
                  • owner@alnoor.com / PROP-001 (عمارة النخيل)
                </button>
                <button type="button" onClick={() => fillDemo('owner@alsalam.com', 'PROP-002')} className="block w-full text-right text-[12px] text-gray-700 hover:text-emerald-600 hover:bg-white px-2 py-1 rounded">
