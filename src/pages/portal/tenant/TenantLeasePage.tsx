  ...
  if (!activeLease) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-[#64748d] text-sm">لا يوجد عقد إيجار حالياً</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-[#64748d] mt-0.5">تفاصيل عقدك الحالي</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Link to="/portal/tenant/notices">
            <Button size="sm" className="h-9 text-xs bg-[#533afd] hover:bg-blue-700">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-[#64748d]">{tt('leases.contractNumber', 'رقم العقد')}</span>
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {daysToEnd > 0 && daysToEnd < 90 && (
              <p className="text-xs text-[#9b6829] flex items-center gap-1">
        ...
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">تاريخ البدء</span>
            ...
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">التجديد التلقائي</span>
            ...
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">إشعار التجديد</span>
              <span className="text-[13px] font-semibold text-[#061b31]">{activeLease.renewal_notice_days} يوم قبل الانتهاء</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">إشعار الإخلاء</span>
        ...
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg">
              <span className="text-xs text-[#64748d]">{tt('leases.rentAmount', 'قيمة الإيجار')}</span>
              <span className="text-sm font-bold text-emerald-700">{formatQAR(activeLease.rent_amount)}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">{tt('leases.paymentFrequency', 'دورية الدفع')}</span>
              <span className="text-[13px] font-semibold text-[#061b31]">{frequencyLabel}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">الضمان</span>
              <span className="text-[13px] font-semibold text-[#061b31]">{formatQAR(activeLease.security_deposit)}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">رسوم إدارية</span>
              <span className="text-[13px] font-semibold text-[#061b31]">{formatQAR(activeLease.admin_fees)}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">العمولة</span>
              <span className="text-[13px] font-semibold text-[#061b31]">{formatQAR(activeLease.commission)}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-[#f6f9fc] rounded-lg">
              <span className="text-xs text-[#64748d]">فترة السماح</span>
            ...
            {unit ? (
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">{tt('units.number', 'رقم الوحدة')}</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.unit_number}</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">{tt('equipment.equipmentType', 'النوع')}</p>
                ...
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">{tt('units.area', 'المساحة')}</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.area_sqm} م²</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">{tt('units.bedrooms', 'غرف النوم')}</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.bedrooms}</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">دورات المياه</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.bathrooms}</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">رقم الموقف</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.parking_number || '—'}</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">عداد الكهرباء</p>
                  <p className="text-[13px] font-semibold text-[#061b31]">{unit.electricity_meter || '—'}</p>
                </div>
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-xs text-[#64748d] mb-0.5">عداد المياه</p>
            ...
            {tenant ? (
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-[#f6f9fc] rounded-lg">
                  ...
                  <div>
                    <p className="text-xs text-[#64748d]">{tt('tenants.name', 'الاسم')}</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-[#f6f9fc] rounded-lg">
                  <Hash className="h-4 w-4 text-[#64748d]" />
                  <div>
                    <p className="text-xs text-[#64748d]">{tt('tenants.code', 'كود المستأجر')}</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-[#f6f9fc] rounded-lg">
                  ...
                  <div>
                    <p className="text-xs text-[#64748d]">الجوال</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-[#f6f9fc] rounded-lg">
                  ...
                  <div>
                    <p className="text-xs text-[#64748d]">البريد</p>
                ...
                {tenant.national_id && (
                  <div className="flex items-center gap-3 p-3 bg-[#f6f9fc] rounded-lg">
                    ...
                    <div>
                      <p className="text-xs text-[#64748d]">الهوية</p>
      ...
      <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
        ...
        <CardContent>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div className="p-3 bg-[#f6f9fc] rounded-lg">
              <p className="text-xs text-[#64748d] mb-0.5">نوع رسوم التأخير</p>
              <p className="text-[13px] font-semibold text-[#061b31]">
            ...
            <div className="p-3 bg-[#f6f9fc] rounded-lg">
              <p className="text-xs text-[#64748d] mb-0.5">قيمة رسوم التأخير</p>
              <p className="text-[13px] font-semibold text-[#061b31]">
