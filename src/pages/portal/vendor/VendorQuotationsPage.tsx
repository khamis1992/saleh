    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-[#64748d] mt-0.5">تقديم عروض أسعار استجابة لطلبات التسعير (RFQ)</p>
        </div>
        <Button onClick={() => setOpen(true)} className="bg-amber-600 hover:bg-amber-700 h-10 text-xs">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
            ...
            <p className="text-xl font-bold text-[#061b31]">{quotations.length}</p>
          </CardContent>
        </Card>
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
        ...
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
            <p className="text-xs text-[#64748d]">معدل القبول</p>
            <p className="text-xl font-bold text-[#533afd]">
              {quotations.length > 0
      ...
      {quotations.length === 0 ? (
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-[#64748d] text-sm">لا توجد عروض أسعار</p>
            <p className="text-[#64748d] text-xs mt-1">ابدأ بتقديم عرض سعر جديد عند استلام طلب RFQ</p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <p className="text-sm font-bold text-[#061b31]">{q.rfq_number}</p>
                      ...
                      {q.notes && <p className="text-xs text-[#64748d] mt-1 line-clamp-2">{q.notes}</p>}
                    </div>
                  </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs">قدم عرض سعر استجابة لطلب RFQ</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div>
              <Label className="text-xs">رقم طلب التسعير (RFQ)</Label>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label className="text-xs">مدة التسليم (يوم)</Label>
