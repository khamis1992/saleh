    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div>
          ...
          <p className="text-[12px] text-[#64748d] mt-0.5">إدارة مطالبات الدفع والمستخلصات</p>
        </div>
        <Button onClick={() => setFormOpen(true)} className="bg-amber-600 hover:bg-amber-700 h-10 text-[12px]">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
            ...
            <p className="text-[20px] font-bold text-[#061b31]">{myClaims.length}</p>
          </CardContent>
        </Card>
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
        ...
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
            <p className="text-[12px] text-emerald-600">{tt('hr.approved', 'معتمد')}</p>
        ...
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="p-4">
            <p className="text-[12px] text-[#ea2261]">{tt('hr.rejected', 'مرفوض')}</p>
      ...
      {sortedClaims.length === 0 ? (
        <Card className="border-0 shadow-[rgba(50,50,93,0.20)_0px_4px_8px_-2px]">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-[#64748d] text-[14px]">لا توجد مطالبات</p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        <p className="text-[14px] font-bold text-[#061b31]">{c.claim_number}</p>
                      ...
                      <p className="text-[12px] text-[#64748d] flex items-center gap-2 mb-3 flex-wrap">
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-3">
                        <div className={`p-2 rounded-lg text-center ${
                          ...
                          <p className="text-[12px] font-semibold">هندسي</p>
                        ...
                        <div className={`p-2 rounded-lg text-center ${
                          ...
                          <p className="text-[12px] font-semibold">مدير مشروع</p>
                          <p className="text-[12px] mt-0.5">
                        ...
                        <div className={`p-2 rounded-lg text-center ${
                          ...
                          <p className="text-[12px] font-semibold">مالية</p>
                          <p className="text-[12px] mt-0.5">
                    ...
                    <Button variant="outline" size="sm" className="h-8 text-[12px]" onClick={() => setViewClaim(c)}>
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-[12px]">املأ تفاصيل المطالبة وأرفق الصور الدالة على نسبة الإنجاز</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              <Label className="text-[12px]">العقد</Label>
              <select
                value={contractId}
            ...
            <div>
              <Label className="text-[12px] mb-2 block">صور موقع العمل</Label>
              <div className="grid grid-cols-4 gap-2">
                ...
                {photos.length < 8 && (
                  <button onClick={handleAddPhoto} className="aspect-square rounded-lg border-2 border-dashed border-[#e5edf5] hover:border-amber-400 flex flex-col items-center justify-center text-[#64748d]">
                    ...
                    <span className="text-[12px]">إضافة</span>
                  </button>
                )}
              </div>
            </div>
            ...
            {claimedAmount && Number(claimedAmount) > 0 && (
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg space-y-1">
                <p className="text-[12px] text-[#9b6829] font-semibold mb-1">حساب الاستحقاق:</p>
                <div className="text-[12px] text-[#9b6829] flex justify-between">
                ...
                <div className="border-t border-amber-200 pt-1 text-[12px] font-bold text-amber-900 flex justify-between">
            ...
            <div className="space-y-3">
              ...
              {viewClaim.engineer_notes && (
                <div className="p-3 bg-[rgba(83,58,253,0.06)] border border-blue-200 rounded-lg">
                  <p className="text-[12px] text-[#533afd] font-semibold">ملاحظات المهندس:</p>
                  <p className="text-[12px] text-blue-900">{viewClaim.engineer_notes}</p>
                </div>
              )}
              {viewClaim.notes && (
                <div className="p-3 bg-[#f6f9fc] rounded-lg">
                  <p className="text-[12px] text-[#64748d] font-semibold">ملاحظات:</p>
                  <p className="text-[12px] text-gray-700">{viewClaim.notes}</p>
                </div>
              )}
            </div>
          )}
